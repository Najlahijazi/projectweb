...
<head>
    ...
    <div class="container">
        ...
        <a href="addadmin.php" class="shop-link">Click here to ADD</a>
        
        <a href="deleteadmin.php" class="shop-link">Click here to DELETE</a>
        
        <a href="updateadmin.php" class="shop-link">Click here to UPDATE</a>
